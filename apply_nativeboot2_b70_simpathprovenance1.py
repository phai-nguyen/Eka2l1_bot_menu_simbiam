    ...
    new='''            msg->function = function;
            ...
            if (nboot2_b70_pr &&
                ...
                LOG_WARN(KERNEL,
                    ...
                    unique_id(),
                    static_cast<int>(msg->args.get_arg_type(0)),
                    static_cast<int>(msg->args.get_arg_type(1)),
                    static_cast<int>(msg->args.get_arg_type(2)),
                    static_cast<int>(msg->args.get_arg_type(3)),
