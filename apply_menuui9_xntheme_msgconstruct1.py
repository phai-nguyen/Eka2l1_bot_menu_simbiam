...
# epoc10 SVC 0xAB from xnthemeserver with r0=message handle and r1=RMessage2*
# shape. Symbian's MessageConstructFromPtr ABI is exactly (message, output ptr).
# Do not infer or fill adjacent 0xAC here.
required = [
...
semantic_marker = "MENUUI9 XNTHEME-MSGCONSTRUCT1: epoc10 SVC 0xAB is MessageConstructFromPtr"
...
try:
    ...
    raise SystemExit("MENUUI9: unable to isolate v10 SVC table") from exc

v10 = svc[v10_begin:v10_end]
if "BRIDGE_REGISTER(0xAB," in v10:
    raise SystemExit("MENUUI9: v10 slot 0xAB unexpectedly already occupied")
if "BRIDGE_REGISTER(0xAC," in v10:
    raise SystemExit("MENUUI9: v10 slot 0xAC unexpectedly occupied; refusing adjacent-slot inference")
...
if v10.count(reg_anchor) != 1:
    raise SystemExit(f"MENUUI9: v10 IPC registration anchor count={v10.count(reg_anchor)}")
reg_replace = """        BRIDGE_REGISTER(0xA9, message_ipc_copy),\n        BRIDGE_REGISTER(0xAA, message_client),\n        // MENUUI9 XNTHEME-MSGCONSTRUCT1: epoc10 SVC 0xAB is MessageConstructFromPtr.\n        BRIDGE_REGISTER(0xAB, message_construct),\n        BRIDGE_REGISTER(0xAD, message_kill),\n"""
